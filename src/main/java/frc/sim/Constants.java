...
public final class Constants {
  ...
  public static final class ElevatorSimConstants {
    ...
    /**
     * The effective load lifted by the elevator. For a continuous elevator this is the total moving
     * mass. For a two stage cascade this is the mass of the first moving stage plus two times the
  ...
  public static final class RollerSimConstants {
    ...
    /** Moment of inertia for the roller mechanism in kg*m^2. */
  ...
  public static final class LauncherSimConstants {
    ...
    /** Moment of inertia for the launcher mechanism in kg*m^2. */
